<?php
/**
 * AccessPress functions and definitions
 *
 ...
 *
 * To override ec_setup() in a child theme, add your own ec_setup to your child theme's
 * functions.php file.
 */
function ec_setup() {
	/**
...
function ec_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Sidebar 2', 'ec' ),
		'id' => 'sidebar-2',
		'description' => __( 'An optional second sidebar area', 'ec' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => "</aside>",
		'before_title' => '<h1 class="widget-title">',
		'after_title' => '</h1>',
...
function ec_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a><span class="byline"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>', 'ec' ),
		esc_url( get_permalink() ),
		esc_attr( get_the_time() ),
		esc_attr( get_the_date( 'c' ) ),
		esc_html( get_the_date() ),
		esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
		esc_attr( sprintf( __( 'View all posts by %s', 'ec' ), get_the_author() ) ),
